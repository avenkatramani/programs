    ...
    def dophase(self,cxn,params,tstart):
        ...
        def y(t):
            if t < t_store:
                ...
                #return params['ctl_store_V']
                return 0 #params['ctl_spike_V']
            elif t < t_read_end - t_spike:
                return 0 #params['ctl_read_V']
            elif t < t_read_end:
                #return params['ctl_store_V']
                 return 0 #params['ctl_spike_V']
            elif t < t_final:
        ...
        def y(t):
            ...
            if t < (t_store):
                ...
                return amp_readout
            elif t < (t_read_end-t_read_cutoff):
...
iterlist = [
    ...
    ['uw_freq_MHz',[11383.823]],
    ['uw_tpi_ns',numpy.linspace(10,1000,30)],
    ['uw_pow_dBm',[7.5]],
    ['readout_V',[0]],#[0.23]
    ['store_V',[0.4]],
